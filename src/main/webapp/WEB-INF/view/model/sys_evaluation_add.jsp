    ...
    <div class="modal-content">
        ...
        <form id="evluForm" class="form-horizontal form" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                <button type="submit" id="btnSaveAll" class="btn btn-primary">保存</button>
...
<script type="text/javascript" src="${ctx}/static/model/sys_evaluation_add.js?version=3.9.9.9.9"></script>
