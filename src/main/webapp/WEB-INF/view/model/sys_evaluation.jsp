                ...
                <div class="m-top-up-15">
                    ...
                    <table id="evaluTable" class="table"
                        ...
                        <tr>
                            ...
                            <th data-field="serial" data-halign="center" data-align="center">所属序列</th>
                            <th data-field="level" data-halign="center" data-align="center">级别</th>
...
<script src="${ctx}/static/model/sys_evaluation.js?v=1.3.11228&${staticVersion}"></script>
<script>
    var rootPath = '${ctx}';
</script>
