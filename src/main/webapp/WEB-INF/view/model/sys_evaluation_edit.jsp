            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="type" class="form-control sp" name="serial" dname="serial">
                            <option></option>
                            <c:forEach items="${dics_sbxl}" var="dic">
                                <option value="${dic.code}" <c:if test="${dic.code ==evalu_Info.serial}">selected</c:if>>${dic.code}|${dic.detail}</option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="type" class="form-control sp" name="level" dname="level">
                            <option></option>
                            <c:forEach items="${dics_ssjb}" var="dic">
                                <option value="${dic.code}" <c:if test="${dic.code ==evalu_Info.level}">selected</c:if>>${dic.code}|${dic.detail}</option>
                            </c:forEach>
                        </select>
                        ...
                        <div class="dataItem" data-repeater-item>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" >
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="id" value="${item.id}" data_name="id">
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select   class="form-control"  name="level"  data_name="formula"   required="required">
                                        <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea  class="form-control" name="evidence"  maxlength="500"
                                               data_name="evidence" required="required"    rows="3"   >${item.evidence}</textarea>
                                </div>
                                <div class="col-sm-2">
...
<script type="text/javascript" src="${ctx}/static/model/sys_evaluation_edit.js?version=3.8.6.6.9"></script>
