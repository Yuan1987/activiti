			...
			<div class="portlet light bordered">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" 
							required="required" name="username" value="${user.name}" readonly="readonly"> 
					...
					<div class="col-sm-4">
						<select name="seq" class="form-control">
							...
							<c:forEach items="${xlList}" var="dic">
								<option value="${dic.code}">${dic.code}|${dic.detail}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" name="jobstype" value="">
						</div>
						<label class="col-sm-2 control-label">岗位层级</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="jobsgrade" required="required" value="">
						</div>
					</div>
				<div id="fpg">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="havequalificationseq"  value="">
						</div>
						<label class="col-sm-2 control-label">已具备资格级别</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="havequalificationgrade" value="">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group date date-picker"  data-date-format="yyyy-mm-dd">
								<input type="text" class="form-control" name="havequalificationgradeTime"  readonly>
						...
						<div class="col-sm-2">
							 <div class="input-group">
	                              <div class="icheck-inline">
	                                  <label>
	                                      <input type="radio" name="nuclearresultsfront" class="icheck">是</label>
	                                  <label>
	                                      <input type="radio" name="nuclearresultsfront" checked class="icheck">否</label>
	                              </div>
                          	</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							 <div class="input-group">
	                              <div class="icheck-inline">
	                                  <label>
	                                      <input type="radio" name="improvementplanclosedloop" class="icheck">是</label>
	                                  <label>
	                                      <input type="radio" name="improvementplanclosedloop" checked class="icheck">否</label>
	                              </div>
                          	</div>
						</div>
					</div>
...
<script type="text/javascript" src="${ctx}/static/model/apply_add.js?11"></script>
