			...
			<div class="portlet light bordered">
					...
					<div class="col-sm-4">
						<select name="seq" class="form-control">
							...
							<c:forEach items="${xlList}" var="dic">
								<option value="${dic.code}" <c:if test="${dic.code==apply.seq}">selected</c:if>>${dic.code}|${dic.detail}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="grade" class="form-control">
							...
							<c:forEach items="${jbList}" var="dic">
								<option value="${dic.code}" <c:if test="${dic.code==apply.grade}">selected</c:if>>${dic.code}|${dic.detail}</option>
							</c:forEach>
						</select>
					</div>
					<label class="col-sm-2 control-label">*申请类型</label>
					<div class="col-sm-4">
						<select name="type" class="form-control" id="authType">
							<option></option>
							<c:forEach items="${sqlxList}" var="dic">
								<option value="${dic.code}" <c:if test="${dic.code ==apply.type}">selected</c:if>>${dic.code}|${dic.detail}</option>
							</c:forEach>
						</select>
					</div>
				</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" name="jobstype" required="required" value="${apply.jobstype}">
						</div>
						<label class="col-sm-2 control-label">岗位层级</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="jobsgrade" required="required" value="${apply.jobsgrade}">
						</div>
					</div>
				<div id="fpg">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="havequalificationseq"  value="${apply.havequalificationseq}">
						</div>
						<label class="col-sm-2 control-label">已具备资格级别</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="havequalificationgrade" value="${apply.havequalificationgrade}">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="workconditionsseq" value="${apply.workconditionsseq}">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" 
								name="workconditionsgrade" value="${apply.workconditionsgrade}">
						</div>
						...
						<div class="col-sm-2">
							 <div class="input-group">
	                              <div class="icheck-inline">
	                                  <label>
	                                      <input type="radio" name="nuclearresultsfront" <c:if test="${apply.nuclearresultsfront}">checked</c:if> class="icheck">是</label>
	                                  <label>
	                                      <input type="radio" name="nuclearresultsfront"  <c:if test="${apply.nuclearresultsfront}">checked</c:if> class="icheck">否</label>
	                              </div>
                          	</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							 <div class="input-group">
	                              <div class="icheck-inline">
	                                  <label>
	                                      <input type="radio" name="improvementplanclosedloop" <c:if test="${apply.improvementplanclosedloop}">checked</c:if> class="icheck">是</label>
	                                  <label>
	                                      <input type="radio" name="improvementplanclosedloop" <c:if test="${apply.improvementplanclosedloop}">checked</c:if> class="icheck">否</label>
	                              </div>
                          	</div>
						</div>
					</div>
...
<script type="text/javascript" src="${ctx}/static/model/apply_edit.js?v=12"></script>
