					...
					<div id="toolbar">
						<form class="form-inline" method="post">
							<select class="form-control" name="status" id="status">
								<c:choose>
									<c:when test="${type==2}">
										<option selected="selected" value="0">待测评</option>
							...
							<!-- <div class="input-group ">
								<button id="searchButton" type="button" class="btn">查询</button>
							</div> -->
						</form>
					</div>
...
<script src="${ctx}/static/model/efcheck.js?222"></script>
<script>
	var rootPath = '${ctx}';
	var type='${type}';//2：为测评打分；其他为审核
</script>
