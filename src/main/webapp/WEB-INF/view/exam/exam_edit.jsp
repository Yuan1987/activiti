				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" id="name" name="name"
							class="form-control" placeholder="" required="required" value="${ex.name}">
					</div>
				</div>
				<div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control sp"   id="seq" name="seq" >
                            ...
                            <c:forEach items="${xlList}" var="dic">
                                <option value="${dic.code}" <c:if test="${dic.code ==ex.seq}">selected</c:if>>${dic.code}|${dic.detail}</option>
                            </c:forEach>
                        </select>
                    </div>
				</div>
                    ...
                    <div class="col-sm-8">
                        <select class="form-control sp"  name="level"   id="level" >
                            ...
                            <c:forEach items="${jbList}" var="dic">
                                <option value="${dic.code}" <c:if test="${dic.code ==ex.level}">selected</c:if>>${dic.code}|${dic.detail}</option>
                            </c:forEach>
                        </select>
                    </div>
				</div>
