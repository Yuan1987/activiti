									...
									<div class="col-sm-4">
										<select name="sex" class="form-control select2">
											...
											<c:forEach items="${xbList}" var="dic">
												<option value="${dic.code}" <c:if test="${dic.code ==userProfile.sex}">selected</c:if>  >${dic.code}|${dic.detail}</option>
											</c:forEach>
										</select>
									</div>
									...
									<div class="col-sm-4">
										<select name="nation" class="form-control">
											...
											<c:forEach items="${mzList}" var="dic">
												<option value="${dic.code}" <c:if test="${dic.code ==userProfile.nation}">selected</c:if>  >${dic.code}|${dic.detail}</option>
											</c:forEach>
										</select>
									</div>
									...
									<div class="col-sm-4">
										<select name="maritalstatus" class="form-control select2">
											...
											<c:forEach items="${hyzkList}" var="dic">
												<option value="${dic.code}" <c:if test="${dic.code ==userProfile.maritalstatus}">selected</c:if>  >${dic.code}|${dic.detail}</option>
											</c:forEach>
										</select>
									</div>
