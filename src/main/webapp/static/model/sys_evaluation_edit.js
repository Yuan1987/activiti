...
$(function() {
    ...
    $('#evluForm').bootstrapValidator({
        ...
        var options=   $('.dataItem:last').find(".form-control");
...
var pageInfo={
    ...
    selectAbilicty:function (preName,sname,id,typeid,evidence,score,formula,passmark) {
        ...
        if (sname == "strinput") {
            ...
            $("[name='" + preName + "[typeid]" + "']").attr("value",typeid).attr("disabled","disabled");
