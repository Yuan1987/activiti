...
evalu.operation = function(value,row) {
	...
	+"<a href=javascript:evalu.editClick('" + row.id + "') title='修改'><span class='fa fa-edit'></span></a>&nbsp;&nbsp;&nbsp;"
    + "<a href=javascript:evalu.deleteOne('"+ row.id + "') title='删除'><span class='glyphicon glyphicon-trash'></span></a>";
