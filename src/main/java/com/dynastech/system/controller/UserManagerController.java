...
public class UserManagerController {
	...
	public ModelAndView edit(String userId) {
		...
		List<String> list= orgManagerService.selectOrgIdsByUserId(userId);
		...
		List<Role> roleList=roleManagerService.selectRolesByUserId(userId);
	...
	@RequiresPermissions("userManager:add")
	@RequestMapping("/add")
	public @ResponseBody Map<String, Object> add(User user,String orgIds,String roleIds) {
		Map<String, Object> data = new HashMap<String, Object>();
		try {
			user.setId(UUID.randomUUID().toString());
			int a = userManagerService.add(user,roleIds.split(","),orgIds.split(","));
	...
	public @ResponseBody Map<String, Object> update(User user,String orgIds,String roleIds) {
		Map<String, Object> data = new HashMap<String, Object>();
		try {
			int a = userManagerService.update(user,roleIds.split(","),orgIds.split(","));
			data.put("message", a > 0 ? I18nUtil.getTextValue("dynastech.common.operation.success"):I18nUtil.getTextValue("dynastech.common.operation.fail"));
	...
	public @ResponseBody Map<String, Object> delete(String id) {
		...
		try {
			...
			int a = userManagerService.delete(id);
			data.put("message", a > 0 ? I18nUtil.getTextValue("dynastech.common.operation.success"):I18nUtil.getTextValue("dynastech.common.operation.fail"));
		} catch (Exception e) {
			data.put("message", I18nUtil.getTextValue("dynastech.common.operation.fail"));
			logger.error("OrgManagerController.add", e);
