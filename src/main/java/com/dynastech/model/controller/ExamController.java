...
import com.dynastech.model.entity.ExamExample.Criteria;
...
public class ExamController {
	...
	public @ResponseBody Map<String, Object> list(HttpServletRequest request,
		...
		PageHelper.orderBy("te.id");
		Map<String, Object> data = new HashMap<String, Object>();
		
		ExamExample ex = new ExamExample();
//		ex.createCriteria().andIsdeletedEqualTo(false);
//		if(!StringUtils.isBlank(searchText)){
//			c.andNameEqualTo("%"+searchText+"%");
//		}
		List<Exam> exam = examService.selectByExample(ex);
